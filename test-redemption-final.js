// Final test to verify the redemption code generation fix
const testRedemptionCodeGeneration = async () => {
  ...
  try {
    ...
    console.log('\nTesting redemption code generation...');
    
    // Test data for generating redemption codes
    const testData = {
    ...
    if (redemptionResponse.ok && redemptionResult.success) {
      console.log('✅ Redemption code generation test PASSED');
